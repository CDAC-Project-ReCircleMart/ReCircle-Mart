...
export default function CreateListing() {
  ...
  return (
    <div className="create-listing"> {/* ✅ scope root */}
      <div className="cl-container">
        <h1 className="cl-page-title">POST YOUR PRODUCT INFORMATION</h1>

        <div className="cl-all-inputs">
          {/* DETAILS */}
          ...
          <section className="cl-card">
            ...
            <div className="cl-photo-grid">
              {Array.from({ length: 8 }).map((_, i) => (
                <div className="cl-photo-box" key={i}>
                  +
                </div>
              ))}
            </div>
        ...
        <button className="cl-post-btn" onClick={submit}>
          POST NOW
        </button>
      </div>
    </div>

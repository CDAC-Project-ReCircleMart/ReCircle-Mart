    ...
    public void updateListingStatus(Long id, String status) {
        ...
        if ("approved".equals(status)) {
            notificationService.createNotification(
                    ...
                    "product_approved",
                    "Product Approved",
                    "Your product \"" + listing.getTitle() + "\" has been approved and is now visible to buyers.",
                    id
            );
            ...
            notificationService.createNotification(
                    ...
                    "product_rejected",
                    "Product Rejected",
                    "Your product \"" + listing.getTitle() + "\" has been rejected. Please review and resubmit.",
                    id
            );
        }
    }
